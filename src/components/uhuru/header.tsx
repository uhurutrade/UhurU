...
const AmazonIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-foreground hover:text-primary">
...
const WhatsAppIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-foreground hover:text-primary" fill="none">
      ...
      isMobile ? "flex-col items-start" : "flex-row items-center"
        ...
        {isMobile && (
          <>
            ...
            <Link href="/about-us" className="text-base font-medium text-foreground hover:text-primary">About Us</Link>
            <Link href="/contact" className="text-base font-medium text-foreground hover:text-primary">Contact</Link>
            <div className="pt-2" />
          </>
        )}
        <a href="mailto:hello@uhurutrade.com" className={cn("text-foreground hover:text-primary font-medium", isMobile ? "text-sm" : "text-[11px]")}>
...
export default function Header() {
  return (
    <header className="sticky top-0 z-50 w-full border-b bg-zinc-100 dark:bg-background/95 backdrop-blur-sm">
      <div className="container mx-auto flex h-14 max-w-7xl items-center justify-between px-4 md:px-6">
        ...
        <div className="hidden md:flex items-center gap-1.5 rounded-full border bg-muted/30 p-0.5 mx-4">
            <Link href="/uhuru-airdrop" className="px-3 py-0.5 text-[10px] font-bold text-foreground hover:bg-background/70 hover:text-primary rounded-full transition-colors uppercase">Airdrop</Link>
            <Link href="/uhurucoin" className="px-3 py-0.5 text-[10px] font-bold text-foreground hover:bg-background/70 hover:text-primary rounded-full transition-colors uppercase">UhuruCoin</Link>
            <Link href="/ai-chat" className="px-3 py-0.5 text-[10px] font-bold text-foreground hover:bg-background/70 hover:text-primary rounded-full transition-colors uppercase">AI Chat</Link>
        </div>
