  ...
  <TooltipProvider>
    <div className={cn(
      ...
      isMobile ? "flex-col items-start" : "flex-row items-center"
        ...
        <a href="mailto:hello@uhurutrade.com" className={cn("text-foreground hover:text-primary font-medium whitespace-nowrap", isMobile ? "text-sm" : "text-xs mr-2")}>
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b bg-zinc-100/90 dark:bg-background/95 backdrop-blur-md">
      <div className="container mx-auto flex h-20 max-w-7xl items-center justify-between px-4 md:px-6">
        ...
        <div className="hidden md:flex items-center gap-2 rounded-full border bg-muted/20 p-1 mx-4">
            <Link href="/uhuru-airdrop" className="px-4 py-1.5 text-xs font-bold text-foreground hover:bg-background/70 hover:text-primary rounded-full transition-colors uppercase whitespace-nowrap">Airdrop</Link>
            <Link href="/uhurucoin" className="px-4 py-1.5 text-xs font-bold text-foreground hover:bg-background/70 hover:text-primary rounded-full transition-colors uppercase whitespace-nowrap">UhuruCoin</Link>
            <Link href="/ai-chat" className="px-4 py-1.5 text-xs font-bold text-foreground hover:bg-background/70 hover:text-primary rounded-full transition-colors uppercase whitespace-nowrap">AI Chat</Link>
        </div>
