          ...
          <div className="flex flex-col gap-2 items-center justify-center mt-4">
            ...
            <div className="flex flex-row items-end justify-center gap-6 sm:gap-10 mt-8 flex-wrap">
              ...
              <Link href="/services/skillhub" className="group z-30 block">
                ...
                >
                  <span className="text-primary dark:text-primary font-black text-3xl md:text-4xl lg:text-[43px] tracking-tighter">£18</span>
              ...
              <Link href="/services/skillhub" className="group z-30 block">
                ...
                >
                  <span className="text-primary dark:text-primary font-black text-3xl md:text-4xl lg:text-[43px] tracking-tighter">£59</span>
              ...
              <Link href="/services/skillhub" className="group z-30 block">
                ...
                >
                  <span className="text-primary dark:text-primary font-black text-3xl md:text-4xl lg:text-[43px] tracking-tighter">£147</span>
